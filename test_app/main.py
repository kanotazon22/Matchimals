...
class LevelSelectScreen(Screen):
    ...
    def build_ui(self):
        ...
        spacing_x = Window.width // (self.levels_per_page + 1)
        base_y = Window.height * 0.5
        offset_y = Window.height * 0.1
        ...
        if end_level < self.max_level:
            arrow_right = ImageButton(
                ...
                size_hint=(None, None),
                size=(120, 120),
                pos=(Window.width - 130, Window.height / 2 - 60)
            )
