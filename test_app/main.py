...
class LevelSelectScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Delay build UI để đợi Window.size ổn định
        Clock.schedule_once(self.delayed_build_ui, 0.1)

        # Theo dõi thay đổi kích thước màn hình
        Window.bind(on_resize=self.on_window_resize)

    def delayed_build_ui(self, dt):
        self.build_ui()
    ...
    def build_ui(self):
        ...
        for i, level_num in enumerate(range(start_level - 1, end_level)):
            ...
            if can_click:
                ...
                btn.on_release = self.select_level
        ...
        exit_btn.on_release = self.exit_to_start
        layout.add_widget(exit_btn)
        ...
        if self.page_index > 0:
            ...
            arrow_left.on_release = self.prev_page
        ...
        if end_level < self.max_level:
            ...
            arrow_right.on_release = self.next_page
